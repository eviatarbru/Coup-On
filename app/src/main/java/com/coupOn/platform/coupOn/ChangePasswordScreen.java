        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    Toast.makeText(ChangePasswordScreen.this, "Check your email to reset password!", Toast.LENGTH_LONG).show();
                }else
                    Toast.makeText(ChangePasswordScreen.this, "Try again! Something went wrong:(", Toast.LENGTH_LONG).show();
